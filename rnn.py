...
from keras.layers import LSTM, Dense, Reshape, SimpleRNN
...
model.add(SimpleRNN(64,activation=act_func, return_sequences=True, input_shape = (x_train.shape[1], 1)))
model.add(SimpleRNN(64,activation=act_func))
